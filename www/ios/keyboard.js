...
Keyboard.fireOnResetKeyboardHeight = function () {
  cordova.fireWindowEvent("keyboardResetHeight");
};
...
Keyboard.resetKeyboardHeight = function () {
  exec(null, null, "CDVIonicKeyboard", "resetKeyboardHeight", []);
};
